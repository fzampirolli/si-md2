...
|---------|-----------|--------|
| 🌐 **HTML** *(recomendado)* | Leitura principal — navegação fluida, figuras nítidas, fórmulas renderizadas | [si-md2.github.io](https://fzampirolli.github.io/si-md2/) |
| 📄 **PDF** | Leitura offline, impressão e uso como fonte no NotebookLM | [PDF disponíveis](https://github.com/fzampirolli/si-md2/blob/main/si-md2/_book_pdf/Sistemas-Inteligentes-e-Minera%C3%A7%C3%A3o-de-Dados.pdf) |
| 🐍 **Notebook (.ipynb)** | Prática interativa — execute, modifique e experimente o código Python | Botão *Executar Colab* no início de cada capítulo |

> 💡 **Dica**: comece pela versão HTML para estudar a teoria, abra o notebook ao lado para praticar, e use o PDF como referência no NotebookLM.
>
> ⏳ **Atenção (Colab)**: as imagens dos notebooks são carregadas do GitHub e podem demorar alguns segundos para aparecer. Se alguma figura não exibir, **recarregue a página** — elas aparecerão normalmente na sequência.
