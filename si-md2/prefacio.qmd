...
|---------|-----------|--------|
| 🌐 **HTML** *(recomendado)* | Leitura principal — navegação fluida com figuras, tabelas e fórmulas | [fzampirolli.github.io/si-md2/](https://fzampirolli.github.io/si-md2/) |
| 📄 **PDF** | Leitura offline, impressão ou uso como fonte no NotebookLM | [fzampirolli.github.io/si-md2/livro.pdf](https://fzampirolli.github.io/si-md2/livro.pdf) |
